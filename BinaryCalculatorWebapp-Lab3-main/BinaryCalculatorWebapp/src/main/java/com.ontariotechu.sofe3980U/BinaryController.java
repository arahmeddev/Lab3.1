...
public class BinaryController {
    ...
    public String result(
        ...
        // Convert input strings to Binary objects
        ...
        switch (operator) {
            ...
            case "*":
                ...
                break;
            default:
                model.addAttribute("result", "Error: Unsupported Operation");
                return "error";  // Make sure to create an `error.html` page in your templates
        }
        return "result";  // Ensure `result.html` properly displays the output
    }
}